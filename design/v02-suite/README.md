...
本轮 R2 更新 P06/P19/P20：根据业务画像自动准备可编辑搜索条件，重新生成保留人工修改，启动确认使用最终草稿。其余 17 张沿用 R1。[交互与验收约定](AI_SEARCH_CONDITIONS.md)。
...
- R2 生成记录：[P06](GENERATION_R2_P06.md)、[P19](GENERATION_R2_P19.md)、[P20](GENERATION_R2_P20.md)，提示词位于 `prompts/r2/`。
