...
it('uses the source URL as visible evidence identity and removes internal version identifiers',async()=>{
  ...
  expect(screen.queryAllByText(/证据版本|查看来源技术信息/)).toHaveLength(0);
  expect(document.body.textContent).not.toContain(unit.evidence[0].sourceVersionId);
