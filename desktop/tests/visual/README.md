...
补证表单隔离场景：`?scenario=P07&candidateReview=dynamic`。显示含TEST采购人与第三方发言的混合网页，原始作者/日期未知；选择来源已打开后可填写本人需求证据，再明确重判。仅检查页面动作和回执形状，TEST服务不承担生产日期/逐字归属校验，也不证明真实商机入库。生产受限PG/HTTP与客户端交叉验证见[补证实施记录](../../../docs/superpowers/plans/2026-09-13-page-demand-evidence.md#evidence)。
