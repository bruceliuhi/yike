...
代码备份：Gitee `codex/customer-pilot` 分支；当前远端提交 `6e9d99c`（完整回归覆盖至该代码提交；本次追加画像校验、重复内容幂等、确认轮换、并发保护、旧版本导入拒绝、画像变更提示和输入长度限制），部署骨架已推送至 `2f8c439e5878cbada47b6354db52d0385279b3d6`。浏览器主流程记录见 `docs/BROWSER_ACCEPTANCE_CP04.md`；该分支尚未部署。
