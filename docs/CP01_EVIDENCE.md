...
结果：CP-01/02/03 数据层、任务租约、四页 Web、来源状态和研究导入测试通过；最新完整命令为 `14 passed in 3.64s`（含真实 PostgreSQL 集成测试；集成测试创建一次性非超级用户 `pilot_app`，验证 RLS 过滤与旧约束升级）。
...
代码备份：Gitee `codex/customer-pilot` 分支，当前最新提交 `0711d1125d56ef125d22462a6b8e00726fbb9b80`。浏览器主流程记录见 `docs/BROWSER_ACCEPTANCE_CP04.md`；该分支尚未部署。
