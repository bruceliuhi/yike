...
| V02-01C / CodexiMac，Win待接收 | IN_PROGRESS；设备公钥/持钥验证子链 | `codex/mac-device-authorization`，base `0a3ccf7`，复用隔离工作树；[实施计划](superpowers/plans/2026-09-09-device-key-possession.md)；新增设备凭据/挑战模块、106迁移、独立权限升级及真实PG测试 | 当前身份/会话基线57项通过；新增实现尚未验收。先补设备owner和退出/提交事务锁，再绑定、验证、轮换、历史回执。连接版本、执行租约/取消/提交授权及Win接收仍未完成，不把此子链称为整卡完成 |
