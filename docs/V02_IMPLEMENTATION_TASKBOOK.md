...
2026-09-13 CodexWin接续：用户已批准隐藏手动设备核验并自动准备，`3ffddbd` 已推main、独立GO并生成固定Windows候选；194项整合回归通过。自动工具不能激活旧窗口，尚未覆盖安装，安装态仍e1bee5a；等关闭旧版后直接升级同包，不重复构包。正式平台连接、真实业务闭环及签名仍未完成。[唯一候选与安装状态](qa/WINDOWS_SYNC_20260912.md)。
