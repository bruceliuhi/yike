...
同步接续：已读取CodexWin主线 `a56aab2`，Windows环境可用，customer记录更新到1119985，Setup文档载荷问题修复后仍待新安装验收；[Windows记录](qa/WINDOWS_SYNC_20260912.md)、[部署记录](qa/SERVER_137138_DEPLOYMENT.md)优先于下方历史“Windows不可用/fbf9f94当前”表述。Mac本批仅合代码，不操作服务器或替Win验收，新增作者源未启用。
