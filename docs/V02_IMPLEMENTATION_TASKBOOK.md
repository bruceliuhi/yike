...
02/MP03知乎接续：已接固定源文件→POST/COMMENT→正式候选数据契约，保持正文、评论归属、原始时间和匿名身份边界；[唯一实施与审核记录](superpowers/plans/2026-09-11-zhihu-source-ingestion.md#实施与验证)。后续必须接受控依赖patch、本人身份与登录、四平台显式配置、普通任务/监控及真实来源验收，当前不可在UI声称知乎可采集；公开网站及完整Goal其它任务不取消。
