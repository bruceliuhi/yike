...
最新接收基线建议：`458dd81863604c7962dc5bdc5dc2634f24bd1032`，已保留Win/R4主线448e88a；连接后端与a8a36fe字节一致。最终非实现者审核PASS，Mac整合后1037后端通过、630桌面通过/21既有条件跳过、typecheck/build通过；原d49失败及修复见验收，不以Mac结果替代Win接收。另含旧collector有界停止与Node夹具冷启动预算修复af0faf6，Win按影响独立验证，不能将设备持钥旧ACK当作连接版本新ACK。
