...
- 功能基线提交：`7451593e2b72e1c7f67d1b0c6b2036772b235e1a`
- Gitee `origin/main` 与 GitHub `github/main` 已同步到该功能基线；随后仅更新本发布记录
- 本机发布候选检查：`local=PASS / external=NOT_VERIFIED / overall=HOLD`
- Lead Radar 全套测试：`71 passed`
- macOS arm64 安装包结构检查和包内冒烟：均 `PASS`
- 当前包为 ad hoc 签名；Developer ID 与公证尚未完成。桌面源码在评测契约之后没有变化，包哈希和完整检查见 [`latest-main-package-f548718.json`](ui-candidate-mac/latest-main-package-f548718.json)。
...
```text
expected: 7451593e2b72e1c7f67d1b0c6b2036772b235e1a
