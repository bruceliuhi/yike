...
- 功能基线提交：`83d3775f0bd6825ac89ab95f71c51280f07fc9d3`
- Gitee `origin/main` 与 GitHub `github/main` 已同步到该功能基线；随后仅更新本发布记录
- 本机发布候选检查：`local=PASS / external=NOT_VERIFIED / overall=HOLD`
- Lead Radar 全套测试：`74 passed`
- macOS arm64 安装包结构检查和包内冒烟：均 `PASS`
- 当前包为 ad hoc 签名；Developer ID 与公证尚未完成。包哈希和完整检查见 [`latest-main-package-83d3775.json`](ui-candidate-mac/latest-main-package-83d3775.json)。
...
```text
expected: 83d3775f0bd6825ac89ab95f71c51280f07fc9d3
