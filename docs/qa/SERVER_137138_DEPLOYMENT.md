...
- 新镜像ID `sha256:938bf7d494d382ef20b092275a8fc93d49f15a38237a2562f21a0918a7495603`，发布digest `sha256:19ac53a47c499727aaa4047a9826ef06e5b2d4b6461d69f035ba512fd6996170`。部署脚本SHA256 `36cb52df5d68bdd2a44966e2693d4200cebd33d1a450915d5f35c53a82571f0d` 独立GO且远端相同；新增139/140，先隔离PG验证37→39、重复迁移、摘要/受限授权及旧服务画像/设备读写，再执行正式备份、迁移/完整最小grant、旧服务ready、18788候选ready、18787切换。
- `backups/yike-before-7599e93.dump.enc`＋版本化认证MAC、`ops/release-before-7599e93.json` 保留。原runtime配置摘要及ops容器不变；未开放外发或新研究能力。正式迁移输出39，运行healthy、重启0、非root、只读、loopback、PG不公开、私密配置权限及日志不泄露检查通过；公网TLS与内网ready均通过。未触发回退，新增结构/数据不自动降级。
- 原始文件集中在远端 `testdata/`：`build-7599e93.log`（中止）、`build-reuse-7599e93.log`、`deploy-7599e93.log`、`migrate-7599e93.log`、`audit-7599e93.py`。真实业务闭环尚未通过。随后同步的 `36a3f99` 公开研究计划来件尚未部署，不追认到本镜像。
