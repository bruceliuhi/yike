...
最新状态：最终Turbo补丁bd384b9经非作者GO，主线程集成为b40cc3b并实际部署；两组显式北京Ark/Turbo配置已装配，候选实际搜索子进程单次合成调用通过。四种业务模型的全部真实客户验收仍未完成。[唯一部署及版本证据](../../qa/SERVER_137138_DEPLOYMENT.md#模型已部署b40cc3b2026-09-11)。下文未部署及旧Flash探针为历史批次边界，不是当前默认配置。
