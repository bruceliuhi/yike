...
后续 `fbf9f94` 已推 main 并实际部署 customer＋ops，完成一次镜像与 Mac 构包、加密备份/迁移/授权/能力检查及实际包匿名表单验收。当前签发/客户登录与重启仍待验；精确镜像/ZIP/部署脚本审查和回滚边界统一见[部署记录](../../qa/SERVER_137138_DEPLOYMENT.md#临时访问码已部署fbf9f942026-09-11)，不继续用“尚未部署”描述当前状态。
