...
Follow-up actual-provider probe and two boundary fixes (`c2169de`, `5c311bb`): [single evidence record](../../qa/DYNAMIC_RESEARCH_REAL_PROBE_20260913.md). Actual 4 MODEL/9 SEARCH succeeded, first READ UNKNOWN and zero candidates; subsequent protocol/restricted-PG fix validation is not a successful rerun. Original local-Skill anonymous sample produced zero handoff-ready and two review-only cards; not a matched A/B. Full real-customer/quality evidence remains open.
