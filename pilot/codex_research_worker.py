                ...
                with tempfile.TemporaryDirectory(prefix='yike-codex-') as directory:
                    ...
                    try:
                        ...
                        with bridge:
                            ...
                            # If the model performed no successful page read, use a
                            # bounded host-owned search/read pass through the same
                            # effect gates. Search snippets alone are never evidence.
                            if (search_enabled and not events.reads and status == 'FAILED'
