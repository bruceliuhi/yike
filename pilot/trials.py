"""Trial entitlement activation AFTER phone OTP verification, never instead."""
import hmac
    ...
    def consume_trial(self, phone: str, code: str, trial_code: str | None) -> str:
        ...
        def activate(connection, user_id):
            ...
            row = connection.execute(
                'SELECT code_hash,days,activated_at,expires_at,revoked_at,redeem_before '
            ...
            digest, days, activated, expires, revoked, deadline = row
