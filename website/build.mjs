...
const fallback = {
  home: `<section class="seo-fallback"><p>意客 AI · 全网智能获客</p><h1>找到正在发生的需求，给销售一条能跟进的机会。</h1><p>意客 AI 从已授权平台与可访问公开来源发现正在发生的需求，整理成带原文证据、匹配理由和下一步动作的销售机会。</p><p><a href="/products/workbench/">了解商机工作台</a>　<a href="/products/crm/">了解客户情报 CRM</a>　<a href="/contact/">申请试用</a></p><h2>核心能力</h2><ul><li>业务画像与搜索条件</li><li>小红书、抖音、B站、知乎等授权平台与公开网页研究</li><li>原文证据、匹配理由、人工复核</li><li>评论与私信草稿、回复记录和客户情报 CRM</li></ul></section>`,
  ...
  scenarios: `<section class="seo-fallback"><p>意客 AI · 适用场景</p><h1>不管卖什么，先找到正在表达需求的客户。</h1><p>方案型销售、销售负责人、顾问与专业服务团队，都可以从公开需求信号开始建立一条可复核的跟进链路。</p><h2>先看见需求，再决定是否值得联系</h2></section>`,
  download: `<section class="seo-fallback"><p>意客 AI · 下载与试用</p><h1>先用一条真实业务，看看它能不能带来可跟进机会。</h1><p>商机工作台提供桌面客户端体验，客户情报 CRM 提供网页产品体验；安装包和授权按版本与连接状态提供。</p></section>`,
  roadmap: `<section class="seo-fallback"><p>意客 AI · 产品路线</p><h1>先把一条从发现到跟进的流程跑通。</h1><p>当前可体验能力、企业方案和持续演进方向分别说明，不把规划能力当成现有交付。</p></section>`,
